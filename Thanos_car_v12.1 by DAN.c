...
void reverse_line_follower(float runtime, int tape_benchmark);
...
int scooper_up = 870;
int scooper_down = 1500;
int scooper_start = 2047;


//the values for the sweeper positions
int sweeper_up = 505;
int sweeper_down = 175;
int sweeper_start = 1004;
int sweeper_grab = 382;
...
void center_1_fire()
{
	...
	//line follows to correct position
        line_follower(6, black_tape);
	...
	drive(1300, r_reg_speed, r_reg_speed);
	...
	//backs up to the second row of people
        reverse_line_follower(28.5, black_tape);	
	...
	//top row of people is knocked over and falls into the sweeper
    	...
    	turn(turn_time/2+400, turn_power, m_port_l);
...
void center_2_fire()
{
    ...
    //backs up to third row of people
        reverse_line_follower(43, black_tape);
        
	//turns to face the second row of people
        turn(turn_time, turn_power, m_port_l);
        
    //servo_change(sweeper_up, sweeper_grab, servo_port_sweeper, 30);
	...
	//turns to face center 1
      //turn(turn_time*2, turn_power, m_port_r);
    
	//line_follower(41, black_tape);
}
//runs the main body of the code
void body()
{
